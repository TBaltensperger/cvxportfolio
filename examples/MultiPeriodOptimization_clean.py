...
# change line 367 in policies.py to     z = cvx.Variable(w.size)
# optimization takes forever on laptop -> reduce loops!

policies={}
# gamma_risks_coarse=[.1,.3,1,3,10,30,100,300,1000]
gamma_risks_coarse=[.1, 10]
# gamma_tcosts_coarse=[1,2,5,10,20]
gamma_tcosts_coarse=[1, 10]
